/**
 * External URLs and social media links for easy management.
 */

export const EXPENSE_REPORT_URL =
  "https://docs.google.com/spreadsheets/d/1FMbmWTWQ9gI4jbYHhUK-whSedCfpvKMxifVC08jAU6E/edit?usp=sharing";
...
export const FUNDRAISING_METRICS = {
  IDS: [
